...
<!--- 000b5d4014648b00000000001

K000SfTAgh0kITXEeSM3AdotTU5esXc --->
...
result="request.b2_authorize_account" username="0008346902ace6d0000000002" password="K000SiBrtphqrbAguqCPJqxeuPIDuyk">
</cfhttp>
...
result="request.b2_list_buckets"
>
    <cfhttpparam name="accountId"  value="#authdata.accountId#">
    <cfhttpparam type="header" name="Authorization"  value="#authdata.authorizationToken#" />
</cfhttp>
